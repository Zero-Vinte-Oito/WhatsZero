...
export default {
  ...
  methods: {
    ...
    // convertHexToColorName(hex) {
    //   const hexWithoutHash = hex.replace('#', '');
    //   const colorName = GetColorName(hexWithoutHash)
    ...
    // async obterTags(ticket) {
    //   try {
    //     const etiqueta = await ObterContato(ticket.contactId);
    //     if (etiqueta) {
    //       const tags = etiqueta.data.tags;
    //       return tags.map(tag => ({ tag: tag.tag, color: tag.color }));
    //     }
    //     return [];
    //   } catch (error) {
    ...
    //   }
    // },
    // async obterCarteiras(ticket) {
    //   try {
    //     const carteira = await ObterContato(ticket.contactId);
    //     if (carteira) {
    //       const wallets = carteira.data.wallets;
    //       return wallets.map(wallet => ({ wallet: wallet.name }));
    //     }
    //     return [];
    //   } catch (error) {
